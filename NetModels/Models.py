...
from NetModels.KernelCustomFreezeConv import *
from NetModels.KernelSinc2CascadeConv import *
...
class NetModel(nn.Module):
    ...
    def __init__(self, options):
        ...
        # 'default' | 'kernel_sinc' | 'kernel_sinc2' | 'kernel_gamma' | 'kernel_gauss' | 'line_net'
        ...
        for i in range(self.N_cnn_lay):
            ...
            if i == 0:
                if self.kernel_type == 'kernel_custom_freeze':
                    self.conv.append(KernelCustomFreezeConv(self.cnn_N_filt[0], self.cnn_len_filt[0], self.fs,
                                                            self.init_filters_path))
                elif self.kernel_type == 'kernel_sinc':
                ...
                elif self.kernel_type == 'kernel_sinc2_cascade':
                    print('kernel_sinc2_cascade')
                    self.conv.append(KernelSinc2CascadeConv(self.cnn_N_filt[0], self.cnn_len_filt[0], self.fs))
