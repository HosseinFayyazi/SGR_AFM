...
class KernelSinc2CascadeConv(nn.Module):
    def __init__(self, N_filt, Filt_dim, fs):
        super(KernelSinc2CascadeConv, self).__init__()
    ...
    def forward(self, x):
        ...
        for i in range(self.N_filt):
            ...
            impulse_response1 = SignalUtils.kernel_sinc2(amp1, f1, f2, t_right)
            ...
            impulse_response2 = SignalUtils.kernel_sinc2(amp1, f3, f4, t_right)
            ...
            impulse_response = (impulse_response - torch.mean(impulse_response) + 1e-6)
